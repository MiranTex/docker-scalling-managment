...
//
// Cópia deliberada de services/database/dbadmin/internal/jwtverify (e de
// services/autoscaler/internal/jwtverify) -- mesmo motivo: cada serviço Go
// deste repo é um módulo independente, sem um módulo partilhado, e esta
// lógica de verificação já foi duplicada por esse motivo mais de uma vez.
// Extrair um módulo partilhado só se a duplicação vier a causar um bug
// corrigido só numa cópia.
package jwtverify
